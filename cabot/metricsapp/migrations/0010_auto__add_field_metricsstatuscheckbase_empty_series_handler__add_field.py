...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetricsStatusCheckBase.empty_series_handler'
        db.add_column(u'metricsapp_metricsstatuscheckbase', 'empty_series_handler',
                      self.gf('django.db.models.fields.CharField')(default='fill_one', max_length=16),
                      keep_default=False)

        # Adding field 'MetricsStatusCheckBase.empty_series_fill_value'
        db.add_column(u'metricsapp_metricsstatuscheckbase', 'empty_series_fill_value',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetricsStatusCheckBase.empty_series_handler'
        db.delete_column(u'metricsapp_metricsstatuscheckbase', 'empty_series_handler')

        # Deleting field 'MetricsStatusCheckBase.empty_series_fill_value'
        db.delete_column(u'metricsapp_metricsstatuscheckbase', 'empty_series_fill_value')
    ...
    models = {
        ...
        'metricsapp.metricsstatuscheckbase': {
            ...
            'empty_series_fill_value': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'null': 'True', 'blank': 'True'}),
            'empty_series_handler': ('django.db.models.fields.CharField', [], {'default': "'fill_one'", 'max_length': '16'}),
