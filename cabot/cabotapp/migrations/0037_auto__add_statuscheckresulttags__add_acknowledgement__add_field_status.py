...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cabotapp_acknowledgement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True)),
            ('resolved_at', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('resolved_reason', self.gf('django.db.models.fields.TextField')(default=None, max_length=255, null=True)),
        ...
        # Adding M2M table for field tags on 'Acknowledgement'
        m2m_table_name = db.shorten_name(u'cabotapp_acknowledgement_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('acknowledgement', models.ForeignKey(orm[u'cabotapp.acknowledgement'], null=False)),
            ('statuscheckresulttags', models.ForeignKey(orm[u'cabotapp.statuscheckresulttags'], null=False))
        ))
        db.create_unique(m2m_table_name, ['acknowledgement_id', 'statuscheckresulttags_id'])

        # Adding field 'StatusCheckResult.acked'
        db.add_column(u'cabotapp_statuscheckresult', 'acked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field tags on 'StatusCheckResult'
        m2m_table_name = db.shorten_name(u'cabotapp_statuscheckresult_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('statuscheckresult', models.ForeignKey(orm[u'cabotapp.statuscheckresult'], null=False)),
            ('statuscheckresulttags', models.ForeignKey(orm[u'cabotapp.statuscheckresulttags'], null=False))
        ))
        db.create_unique(m2m_table_name, ['statuscheckresult_id', 'statuscheckresulttags_id'])


    def backwards(self, orm):
        # Deleting model 'StatusCheckResultTags'
        db.delete_table(u'cabotapp_statuscheckresulttags')

        # Deleting model 'Acknowledgement'
        db.delete_table(u'cabotapp_acknowledgement')

        # Removing M2M table for field tags on 'Acknowledgement'
        db.delete_table(db.shorten_name(u'cabotapp_acknowledgement_tags'))

        # Deleting field 'StatusCheckResult.acked'
        db.delete_column(u'cabotapp_statuscheckresult', 'acked')

        # Removing M2M table for field tags on 'StatusCheckResult'
        db.delete_table(db.shorten_name(u'cabotapp_statuscheckresult_tags'))
    ...
    models = {
        ...
        u'cabotapp.acknowledgement': {
            ...
            'resolved_at': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'resolved_reason': ('django.db.models.fields.TextField', [], {'default': 'None', 'max_length': '255', 'null': 'True'}),
