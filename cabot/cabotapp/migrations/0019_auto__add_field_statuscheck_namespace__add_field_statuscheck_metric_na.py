...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatusCheck.namespace'
        db.add_column(u'cabotapp_statuscheck', 'namespace',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'StatusCheck.metric_name'
        db.add_column(u'cabotapp_statuscheck', 'metric_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'StatusCheck.dimension_name'
        db.add_column(u'cabotapp_statuscheck', 'dimension_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'StatusCheck.dimension_value'
        db.add_column(u'cabotapp_statuscheck', 'dimension_value',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)

        # Adding field 'StatusCheck.granularity'
        db.add_column(u'cabotapp_statuscheck', 'granularity',
                      self.gf('django.db.models.fields.IntegerField')(default=300),
                      keep_default=False)

        # Adding field 'StatusCheck.statistic'
        db.add_column(u'cabotapp_statuscheck', 'statistic',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'StatusCheck.percentile'
        db.add_column(u'cabotapp_statuscheck', 'percentile',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatusCheck.namespace'
        db.delete_column(u'cabotapp_statuscheck', 'namespace')

        # Deleting field 'StatusCheck.metric_name'
        db.delete_column(u'cabotapp_statuscheck', 'metric_name')

        # Deleting field 'StatusCheck.dimension_name'
        db.delete_column(u'cabotapp_statuscheck', 'dimension_name')

        # Deleting field 'StatusCheck.dimension_value'
        db.delete_column(u'cabotapp_statuscheck', 'dimension_value')

        # Deleting field 'StatusCheck.granularity'
        db.delete_column(u'cabotapp_statuscheck', 'granularity')

        # Deleting field 'StatusCheck.statistic'
        db.delete_column(u'cabotapp_statuscheck', 'statistic')

        # Deleting field 'StatusCheck.percentile'
        db.delete_column(u'cabotapp_statuscheck', 'percentile')
    ...
    models = {
        ...
        u'cabotapp.statuscheck': {
            ...
            'dimension_name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'dimension_value': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            ...
            'granularity': ('django.db.models.fields.IntegerField', [], {'default': '300'}),
            ...
            'metric_name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'metric_selector': ('django.db.models.fields.CharField', [], {'default': "'value'", 'max_length': '50'}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'namespace': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'password': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'percentile': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'statistic': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
